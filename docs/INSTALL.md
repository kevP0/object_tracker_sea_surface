...
2. Install packages for Python 3.7:
    ...
    5. Install MultiScaleDeformableAttention package: `python src/object_tracker_sea_surface/models/ops/setup.py build --build-base=src/bject_tracker_sea_surface/models/ops/ install`
